...
const { lodashEscape } = require("lodash");
...
module.exports = (eleventyConfig) => {
	...
	eleventyConfig.addFilter("escape", lodashEscape);
	...
	// 	--------------------- Custom transforms ---------------------
	eleventyConfig.addTransform("html-minifier", compressHTML);
	...
	["src/assets/fonts/", "src/assets/images/", "src/assets/downloads/"].forEach(
